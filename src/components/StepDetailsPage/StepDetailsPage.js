    ...
    <div>
      <div className="stepDetailsPage-div">
        ...
        <p className="stepDetailsPage-p">
          ...
          মিডিয়ামের সুপার এফিশিয়েন্ট একজন student রাও যেনো এতে অংশগ্রহণ করতে
          পারে এবং একটি Future গড়ে তুলতে পারে।
        </p>
        ...
        <div className="stepDetailsPage-stepTwo-flex-div">
          <div>
            ...
            <div className="stepDetailsPage-common-blank-div"></div>
            <p className="stepDetailsPage-step-p">
              “Basic English Communication” কোর্সটি সংগ্রহ করুন এবং এটি শেষ
              করুন। প্রতিদিন কমবেশী ২ ঘন্টা সময় দিন। প্রতিটি সেকশনে নিজেকে Test
              করুন এবং অতপর পুরোপুরি বোঝা হলে পরের সেকশনে যান। “Basic English
              Communication” কোর্সটি আপনি ধাপে ধাপে অল্প অল্প করে কিংবা সব সেকশন
              একবারে সংগ্রহ করতে পারবেন। এই কোর্সটিতে ৩০+ টি মডিউল (সেকশন)
              রয়েছে। কোর্সটি এখান থেকে সংগ্রহ করুন:{" "}
              <Link
        ...
        <div className="stepDetailsPage-stepThree-flex-div">
          <div>
            ...
            <div className="stepDetailsPage-common-blank-div"></div>
            <p className="stepDetailsPage-step-p">
              “Core Skills” Section থেকে যে কোন একটি কোর্স সংগ্রহ করুন এবং এটি
              শেষ করুন। প্রতিদিন কমবেশী ২-৩ ঘন্টা সময় দিন। কোর্সটি এখান থেকে
              সংগ্রহ করুন :
              <Link
                to="https://bd.teacherjackonline.com/"
                target="blank"
        ...
        <div className="stepDetailsPage-stepSix-flex-div">
          ...
          <div className="skillDevelopment-img-div">
            <img
              className="skillDevelopment-img"
        ...
        <div className="stepDetailsPage-stepSeven-flex-div">
          <div>
            ...
            <div className="stepDetailsPage-common-blank-div"></div>
            <p className="stepDetailsPage-step-p">
              আমাদের নিজস্ব Company তে যে opening গুলো আছে সেগুলোতে আপনার Skill
              বা Work Section অনুসারে Apply করুন। আমাদের Online / Offline /
              Hybrid – সবগুলো Mode এই employees প্রয়োজন হয়। এগুলো সম্পর্কে জানতে
              এই ভিডিওগুলো দেখুন -
            </p>
          </div>

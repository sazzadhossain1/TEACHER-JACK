      ...
      <div className="earnOnlineJob-grid-div">
        ...
        <div className="earnOnlineJob-text-div">
          ...
          <p className="earnOnlineJob-p">
            রিমোট জব/ফ্রিল্যান্সিং করে সাধারণ একজন ব্যক্তি সর্বনিম্ন কয়েক হাজার
            টাকা থেকে শুরু করে ১ বছরের মধ্যে ৩০,০০০ থেকে ৪০,০০০ টাকা সহজেই ইনকাম
            করতে পারে। চোখ কান খোলা থাকলে এবং একটু বেশি পরিশ্রমী হলে আরো বেশি
            ইনকাম করতে পারে
          </p>

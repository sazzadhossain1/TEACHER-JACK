      ...
      <div className="meetOurCeo-grid-div">
        ...
        <div className="meetOurCeo-text-div">
          ...
          <p className="ceo-text-p">
            Zakir Hossain is one of the most prominent Information Technology
            Businessperson, an Author and a Trainer. He is TESOL Certified, ELT
            Teacher. He also provides training on information technology related
            subjects to students in many different countries. Zakir Hossain
            (Jack) is experienced and has taught students from China, South
            Korea, Mexico, Bangladesh, Canada and the United States of America
            over the last 8 years. He is friendly, helpful, open minded and
            affordable. He goes the extra mile to ensure student understanding
            of the lessons. He travels a lot and interacts with people from
            different background. He is knowledgeable and knows exactly which
            student requires what level of training. He is easily reachable and
            is always ready to mentor his trainees.
          </p>
          <p className="ceo-text-p">
            Zakir Hossain completed his ‘O Level’ under The University of
            Cambridge. Zakir completed his B.Sc in Management Information System
            (MIS) and M.A in English Language Teaching (ELT) from the USA. His
            childhood was quite cheerful. He kept busy with social work from the
            early stages of his life. He excelled in his school studies and
            always came out in flying colors.
          </p>
          <p className="ceo-text-p">

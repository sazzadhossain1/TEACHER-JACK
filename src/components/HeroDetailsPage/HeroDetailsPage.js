    ...
    <div>
      <div className="HeroDetailsPage-parent-div">
        <div className="heroDetailsPage-heading-text-div">
          ...
          <p className="heroDetailsPage-qus">
            {" "}
            School or College Student (স্কুল, কলেজ পড়ুয়া শিক্ষার্থী) ?{" "}
          </p>
          <p className="heroDetailsPage-qus">
        ...
        <div className="heroDetailsPage-single-first-p-div">
          ...
          <p className="heroDetailsPage-single-first-p">
            দেশে হাজারও বই রয়েছে, লক্ষ লক্ষ Youtube ভিডিও রয়েছে যেখানে নানা
            ধরণের আইডিয়া দেয়া হয়, Lesson দেয়া হয় – কিছু রয়েছে সত্য আবার কিছু
            রয়েছে মিথ্যা মিশ্রিত। আপনি যেনো সঠিক গাইডলাইনটি পান, সেজন্যই আমার এ
            উদ্যোগ। আমার যে কোন কথা নেয়ার আগে সেগুলো যাচাই করে নেবেন যাতে কোন
            রকম দ্বিধা ছাড়া আপনি একটি সঠিক সিদ্ধান্ত নিজেই নিতে পারেন। আমি
            চেষ্টা করবো যতটুকু পারি Authentic Reference দিতে যাতে আপনাদের সুবিধা
            হয়।
          </p>
        </div>
